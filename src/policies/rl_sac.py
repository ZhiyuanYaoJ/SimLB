...
class NodeRLBSAC(NodeLB):
    ...
    def __init__(
        ...
        SAC_training_confs['model_path'] = logger_dir.rstrip('rl.log')
        ...
        self.sac_trainer = SAC_Trainer(self.replay_buffer, n_feature_as=N_FEATURE_AS, n_feature_lb=N_FEATURE_LB,
                                       ...
                                       action_dim=max_n_child, logger=self.logger)
    ...
    def get_state(self, ts, nodes=None):
        ...
        feature_lb = list(feature_as[self.child_ids].mean(axis=0)) + [obs[k] for k in FEATURE_LB_ALL] # feature_lb has averaged as feature + lb feature
