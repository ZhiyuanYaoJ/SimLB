...
b_offsets = [1]
# b_offsets = [1, 2]
# fct_pairs = [(0.5, 0.5), (0.75, 0.25)] # fct_cpu & fct_io pairs
fct_mus = [0.5, 0.75, 1.0]
# fct_pairs = [(0.25, 0.25)]  # fct_cpu & fct_io pairs
...
if __name__ == "__main__":  # confirms that the code is under main function
    ...
    experiment_name = 'input-fct-reduce'
        ...
        for n_as in n_ass:
            for n_worker in n_workers:
                for fct_mu in fct_mus:
                    ...
                    print(setup)
                    cmd_preamable = 'python3 run.py --n-lb {} --n-as {} --n-worker {} --cpu-fct-mu {} --process-n-stage {} --io-fct-mu {} --n-flow {} --n-episode {} --first-episode-id {} --lb-bucket-size {}'.format(
                        n_lb, n_as, n_worker, fct_mu, n_process_stage, fct_io, n_flow_total, n_episode, first_episode_id, n_lb_bucket)
